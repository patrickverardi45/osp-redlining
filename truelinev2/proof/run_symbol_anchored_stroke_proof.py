...
# M8.14.c re-homing (conclusions unchanged): the b.3 pure stroke-anchor laws
# now live in extract/stroke_anchor.py for the lane; names re-exported here so
# the b.3/b.7 gates and tests run verbatim.
from truelinev2.extract.stroke_anchor import (  # noqa: E402
    LABEL_MIN_SEP,
    RIVAL_MIN_SEP,
