...
# (corrected_sheets set). BOTH stay refused until render + seam promotion. (Currently the held-back set is
# {log36, log52, log58}: log36 anchored-only (corrected_sheets []); log52/log58 anchored + owner-set sheets.)
...
def main() -> int:
    ...
    #     held-back category. (Currently held-back: {log36, log52, log58}.)
